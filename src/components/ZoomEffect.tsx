...
const ZoomEffect = () => {
  ...
  return (
    <div className="banner w-full  h-[100svh] max-h-255 relative">
      <div className="flex w-full gap-4 items-center justify-center overflow-hidden absolute top-1/2 left-1/2 -translate-1/2 z-5">
        <div className="text-3xl shrink left-text whitespace-nowrap">
          Recommendation By
        </div>

        <div className="text-3xl shrink right-text whitespace-nowrap here">
          Real people
        </div>
      </div>
